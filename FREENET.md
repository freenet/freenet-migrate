...
- **Code hash:** `E6CUUEuYPUT4GoW9C4d279oK1p8b5RUKiSScqnExc1Yb` — recorded in [`contracts/pointer-contract/CODEHASH`](contracts/pointer-contract/CODEHASH), artifact committed at [`contracts/pointer-contract/pointer-v1.wasm`](contracts/pointer-contract/pointer-v1.wasm).
