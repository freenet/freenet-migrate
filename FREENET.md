...
- **Code hash:** `9V7mTtJjz8Y4Vmkhta38fTzvVF1pxfwzC6NWvGx3FiEG` — recorded in [`contracts/pointer-contract/CODEHASH`](contracts/pointer-contract/CODEHASH), artifact committed at [`contracts/pointer-contract/pointer-v1.wasm`](contracts/pointer-contract/pointer-v1.wasm).
